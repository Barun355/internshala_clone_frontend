    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACKEND_API}/internship`
        );
        setInternData(prev => response.data);
        setFilterInternship(prev => response.data);
              ...
              <div className="m-4">
                ...
                <div className="all-ele">
                  ...
                  <div className="flex text-sm justify-between">
                    ...
                    <p className="mt-3">
                      {" "}
                      <i className="bi bi-calendar-check-fill"></i> Duration{" "}
                      <br />
                      {data.Duration}
                    </p>
                    ...
                    <p className="mt-3">
                      {" "}
                      <i className="bi bi-cash"></i> Stipend <br />{" "}
                      {data.stipend}
                    </p>
                  </div>
                </div>
