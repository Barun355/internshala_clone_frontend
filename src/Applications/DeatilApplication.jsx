  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_API}/application/${id}`
      );
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-24 justify-around">
                  <button
                    className="bg-blue-700 text-green-400 w-24 font-semibold px-5 py-2"
                    onClick={() => handleAcceptAndReject(data._id, "accepted")}
                  >
                    Accept
                  </button>
                  <button
                    className="bg-blue-700 text-red-600 w-24 font-semibold px-5 py-2"
