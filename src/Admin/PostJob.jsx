...
function PostJOb() {
  ...
  const sendData = (e) => {
    ...
    if (
      ...
      axios
        .post(`${process.env.REACT_APP_BACKEND_API}/job`, bodyJosn)
        .then((res) => {
    ...
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        >
          ...
          <button className="hover:bg-blue-600 w-fit px-10 py-6 font-semibold font-mono text-2xl">Post Job</button>
        </form>
      </div>
    </div>
  );
